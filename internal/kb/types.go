...
type ProgramDoc struct {
	...
	SideBySideComparisons    []Doc              `json:"documentation_side_by_side_comparisons,omitempty"`
	MigrationScripts         []Doc              `json:"documentation_migration_scripts,omitempty"`
	ComponentLibraryMappings []Doc              `json:"documentation_component_library_mappings,omitempty"`
	MigrationValidationTests []Doc              `json:"documentation_migration_validation_tests,omitempty"`
